...
・マッチングキャストのロール比率は自身を除いた割合になります。<br>
　ただし全国対戦（舞踏会を除く）では、自身の選択したロールと同じロールをペアとしているものとして、その分を減算した結果を表示しています。<br>
（例：ファイター4人（自身含）、アタッカー2人、サポーター2人の場合＝ファイター2人、アタッカー2人、サポーター2人として扱う）<br>
　また、回線切断による7人COM戦や、ロールが合わないマッチングが発生した場合は数値にズレが発生します。
